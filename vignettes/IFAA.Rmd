...
- `microbVar`: This takes vector of taxon names that the user specifically interested in. Default is NULL. When non-empty, the output will only contain specified taxa, and P-value adjustment will only be applied to the specified taxa. 
...
results <- MZILN(
  experiment_dat = test_dat,
  microbVar = c("x1", "x2", "x3"),
  refTaxa = c("rawCount10"),
  sub_taxa = c("rawCount1", "rawCount2", "rawCount3"),
  sampleIDname = "ID",
  fdrRate = 0.05,
  paraJobs = 2
)
